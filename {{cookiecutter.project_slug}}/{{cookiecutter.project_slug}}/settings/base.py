...
# Add apps in configs/apps.json in case you want to have multiple apps 
APPS_CONFIG_PATH = os.path.join(str(BASE_DIR), 'configs', 'apps.json')
APPS_LOCAL = read_json(APPS_CONFIG_PATH) if os.path.exists(APPS_CONFIG_PATH) else []
APPS_LOCAL = APPS_LOCAL or []
...
PROJECTS = [
    '{{cookiecutter.project_slug}}.abstract.apps.AbstractConfig',
